        ...
        <div className='pt-6'>
           <PageTitle title='Pesquisa'/>
            ...
            { !sucess && <div className='w-1/5 mx-auto'>
                ...
                { notas.map((nota,key) => {
                    return (<label key={key} className='block w-1/6 text-center'>
                        {nota} <br />
            ...
            { sucess && <div className='w-1/5 mx-auto'>
                <p className='m-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3'>Obrigado por contribuir com sua sugestão ou crítica</p>
                {
